...
class UploadedFiles(Base):
    ...
    failed_count: Mapped[int | None] = mapped_column(Integer, default=0, nullable=True)
    failed_db_count: Mapped[int | None] = mapped_column(Integer, server_default="0", nullable=True)
