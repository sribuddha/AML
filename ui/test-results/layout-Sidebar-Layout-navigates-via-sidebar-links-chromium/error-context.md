...
- Name: layout.spec.ts >> Sidebar Layout >> navigates via sidebar links
- Location: ..\tests\e2e\ui\layout.spec.ts:23:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByText('Compliance') resolved to 2 elements:
    1) <span>Compliance</span> aka getByRole('link', { name: '🛡️ Compliance', exact: true })
