...
- Name: rules.spec.ts >> Rules Page >> creates a new rule
- Location: ..\tests\e2e\ui\rules.spec.ts:30:7
...
Locator: getByText('Test E2E Rule')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Test E2E Rule')
...
- main:
  ...
  - text: Type
  - textbox "Filter by type": Test E2E Rule
  - text: Status
  - combobox:
    - option "All" [selected]
    - option "Active"
  ...
  - textbox
  - text: Rules JSON
  - textbox: "[ { \"field\": \"amount\", \"operator\": \"gt\", \"value\": 10000 } ]"
